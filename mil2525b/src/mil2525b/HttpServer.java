...
public class HttpServer extends TcpServer implements TcpServer.Listener {
    ...
    private final static Pattern MIL2525B_PATTERN = Pattern.compile( "^GET /mil2525b/(([a-zA-Z\\-]{15})).*" );
    private final static Pattern COT_PATTERN = Pattern.compile( "^GET /cot/(([a-zA-Z\\-]+)).*" );
    
    private ExecutorService exec = Executors.newCachedThreadPool();
    private Collection<HttpServer.HttpListener> listeners = new LinkedList<HttpServer.HttpListener>();                // HttpEvent listeners
