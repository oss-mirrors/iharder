...
@interface ABSController : NSObject
{
    ...
    IBOutlet NSButton     *defaultCountryCodeCheckBox;
    IBOutlet NSTextField  *defaultCountryCode;
    
    IBOutlet NSButton            *CDYNECheckBox;
    IBOutlet NSTextField         *CDYNEStatus;
    IBOutlet NSProgressIndicator *CDYNEProgress;

    IBOutlet NSButton     *scrubAddressBookButton;

    NSTimer *fixLabelsStatusTimer;
    NSTimer *formatPhoneNumbersStatusTimer;
    NSTimer *CDYNEStatusTimer;
